...
> [!IMPORTANT]
> Version 0.1.0 is an unsigned public preview. macOS may display a security
> warning during the first launch. Follow the safe instructions in
> [INSTALL.md](INSTALL.md). Signed and notarized builds are coming soon.
...
This repository tracks GUI bugs and product feedback:
...
This is the public download, documentation, and issue-tracking repository for
Command Code GUI. Application development happens in a private repository.
